    ...
    <tr className="border-t border-b border-[#000000]">
      ...
      <td className="py-2 px-4 align-middle border-b border-[#000000]">
        <div className="flex items-center cursor-pointer" onClick={toggleAvailability}>
          <img 
            src={isAvailable ? "/images/switch.png" : "/images/switchapagado.png"}
            alt="Disponible" 
            className="w-10 h-10"
          />
    ...
    <div className="flex flex-col mt-4">
      <div className="flex justify-end items-center gap-4 p-2">
        ...
        <div className="flex items-center gap-2">
          <span className="font-Roboto text-[12px] font-normal text-[#D77408]">10</span>
          <img src="/images/Flechadepaginacion.svg" alt="Flecha de paginación" />
        </div>
        <span className="font-Roboto text-[12px] font-normal text-[#D77408]">1-5 de 13</span>
        <div className="flex gap-2">
          <img src="/images/flechaizquierdapaginacion.svg" alt="Flecha izquierda" />
      ...
      <div className="flex flex-col items-center justify-center flex-1 w-full p-4 md:p-8 lg:p-8 xl:p-10">
        ...
        <div className="w-full max-w-6xl bg-[#FAFAFA] shadow-lg rounded-lg p-6">
          ...
          <div className="relative flex items-center self-stretch gap-2 mb-4 flex-wrap">
            <div className="flex items-center gap-2">
              <div className="flex items-start gap-2">
                <img src="/images/iconocolumnas.svg" alt="Icono Columnas" className="w-6 h-6" />
                <span className="text-[#F39C12] font-Ubuntu text-[16px] font-medium leading-normal">
                  Columnas
                </span>
              </div>
              <div className="flex items-start gap-2">
                <img src="/images/Filtros.svg" alt="Icono Filtros" className="w-6 h-6" />
                <span className="text-[#F39C12] font-Ubuntu text-[16px] font-medium leading-normal">
                  Filtros
                </span>
              </div>
              <div className="flex items-start gap-2">
                <img src="/images/Exportar.svg" alt="Icono Exportar" className="w-6 h-6" />
                <span className="text-[#F39C12] font-Ubuntu text-[16px] font-medium leading-normal">
                  Exportar
                </span>
              </div>
          ...
          <TableRow product="Wings" unitsAvailable={60} inventory="80/300" />
            <TableRow product="Boneless" unitsAvailable={60} inventory="80/300" />

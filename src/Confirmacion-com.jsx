          ...
          <div className="flex-1 flex flex-col space-y-80">
            <div className="flex flex-col items-center bg-white p-4 rounded-xl">
              <div className="flex items-center pb-2 w-full relative">
                ...
                />
                {isVisible && (
                  <div className='fixed flex-col inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50'>
                    <div className='bg-slate-200 p-6 shadow-lg w-3/4 rounded-t-lg'>
                    ...
                    <div className='bg-slate-200 p-6 shadow-lg w-3/4'>
                    ...
                    <div className='bg-slate-200 p-6 shadow-lg w-3/4 flex py-10 justify-around rounded-b-lg'>
                    <button
                    className="mt-4 px-20 py-2 bg-orange-500 text-white rounded-md hover:bg-orange-600"
                    
                    >
                   Send
                   </button>
                   <button className="mt-4 px-20 py-2 bg-orange-500 text-white rounded-md hover:bg-orange-600"

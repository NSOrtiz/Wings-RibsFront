...
export default function Inventarios() {
  return (
    <div className=" flex flex-row gap-8 border-b border-neutral-500 mb-6">
      <p className=" col-span-full font-bold text-center basis-1/3">Wins</p>
      <p className="font-bold text-center basis-1/2 ">60</p>
      <p className="font-bold text-center basis-1/2">80/300</p>
      ...
      <label className="inline-flex items-center cursor-pointer basis-1/4">
        ...
        <span className="font-bold text-center pl-2 basis-1/4">Disponible</span>
      </label>
    </div>
  );
}
